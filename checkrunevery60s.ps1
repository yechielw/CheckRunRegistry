$runStart = Get-itemProperty -path "HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\Run"
...
while($true){
    ...
    $tempRun = Get-itemProperty -path "HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\Run"
